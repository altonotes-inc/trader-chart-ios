...
private let decimalNumberOne = NSDecimalNumber(string: "1")
private let decimalNumberTen = NSDecimalNumber(string: "10")

internal extension NSDecimalNumber {
    static var one: NSDecimalNumber {
        return decimalNumberOne
    }
    
    static var ten: NSDecimalNumber {
        return decimalNumberTen
    }
